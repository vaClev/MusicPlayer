...
/// Демонстрирует большую связность кода. Нарушает Single Responsability Principle
/// Шаг рефакторинга №1. Выделен класс MusicFileRepository - ОК
/// Шаг Рефакторинга #2. Маппирование в DTO вынести в отдельный класс.
///
