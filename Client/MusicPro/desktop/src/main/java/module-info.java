module org.example.vasilev.musicpro {
    // === Зависимости модуля ===
    //requires musicpro.common;           // ← ВАЖНО: ваш common модуль!
    ...
    requires musicpro.common;

    // === Экспортируем "запускатель" ===
    exports org.example.vasilev.musicpro.desktop.launcher;

    // === Экспортируем desktop пакеты для FXML ===
